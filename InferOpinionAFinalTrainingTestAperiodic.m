function []=InferOpinionAFinalTrainingTestAperiodic(Dataset,trainingWidth,regValIdx,thr)
 regValv=[0];
        ...
        if init==final
          randlast=1;
           ...
           for xx=1:randlast 
                ...
                r=rx(xx,:);
%                 Ak=1*Adj;
                if fl==1\section{Almost sure regret}
...
%                 clear px
           ...
           eval(['save ../realDataOut/Learned_',Dataset,'_',num2str(trainingWidth),'_',num2str(regValIdx),'_',num2str(init),'_',num2str(final),'_x  graphxData']);
           clear errorv
           clear randomseq
           clear mat
           clear adj_mat;
